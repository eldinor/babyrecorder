import {
  EffectWrapper
} from "./chunk-YGLBU2TJ.js";
import {
  Engine,
  SphericalHarmonics,
  SphericalPolynomial
} from "./chunk-NUT6KUXH.js";
import {
  Texture
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-OWNPDPST.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-RBHUBQ4X.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-DRRDBJ2G.js")]));
    }
  }
  /**
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-5UNPH7XY.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-PYQDHKN6.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-HABJIVI3.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-UVGHUMWC.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
//# sourceMappingURL=chunk-CHBWH6DO.js.map
